// DACELIB Benchmark: DA derivative chains (T3)
// Matches: examples/performance/non_mpi/12_da_derivatives/bench_t3.rosy
...
int main() {
    ...
    std::cout << "DA Derivatives Benchmark (DACELIB): order 10, 3 vars, 50000 iterations" << std::endl;
