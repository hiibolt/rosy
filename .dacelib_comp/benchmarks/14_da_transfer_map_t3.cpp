// DACELIB Benchmark: DA transfer map for a FODO cell (T3)
// Matches: examples/performance/non_mpi/14_da_transfer_map/bench_t3.rosy
...
int main() {
    ...
    std::cout << "DA Transfer Map Benchmark (DACELIB): order 5, 6 vars, 50000 iterations" << std::endl;
