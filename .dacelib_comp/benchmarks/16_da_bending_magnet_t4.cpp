// DACELIB Benchmark: DA sector bending magnet with edge focusing (T4)
// Matches: examples/performance/non_mpi/16_da_bending_magnet/bench_t4.rosy
...
int main() {
    ...
    std::cout << "DA Bending Magnet Benchmark (DACELIB): order 5, 4 vars, 50000 iterations" << std::endl;
