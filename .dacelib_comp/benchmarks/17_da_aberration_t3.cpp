// DACELIB Benchmark: DA aberration coefficient extraction (T3)
// Matches: examples/performance/non_mpi/17_da_aberration/bench_t3.rosy
...
int main() {
    ...
    std::cout << "DA Aberration Benchmark (DACELIB): order 5, 6 vars, 10000 iterations" << std::endl;
