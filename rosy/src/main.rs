//! # ROSY Transpiler
//!
//! A modern Rust-based transpiler for the ROSY programming language,
//! designed for scientific computing and beam physics applications.
//!
//! ## Overview
//!
//! Rosy converts ROSY source code into self-contained, native Rust executables
...
//! ## IDE Support
//!
//! A VSCode extension for ROSY syntax highlighting is available in
//! `rosy_ide_tools/rosy-vscode-extension/`. Install it by:
//!
//! 1. Open VSCode
//! 2. Run `Extensions: Install from VSIX...` from the command palette
//! 3. Select the `.vsix` file generated by `cargo run --bin generate_vscode_extension`
//!
//! ## Building the Docs
//!
//! ```bash
